<div class="product__header_contener " style="background-image: url('<?php echo esc_url( get_theme_file_uri() ); ?>/asset/images/background_bo.png');">
    <div class="product__header "  data-productid="369860">
        <div class="wrap">
            <div class="product__header-infos">
                <h1 class="product__title"> <?php the_title() ?> </h1>
                <h2 class="product__subtitle"> <?php the_category() ?>
                </h2>
                ...
                <ul class="product__attributes attributes">
                    <li class="attributes__item"><img
                            src="<?php echo esc_url( get_theme_file_uri() ); ?>/asset/images/picto-a-distance-plus-presentiel.html"
            ...
            <div class="product__header-sidebar">
                ...
                <div data-video-open="" data-embed-url="https://www.youtube.com/embed/ubaZlBt17Tg"
                    ...
                    <div class="product__video-thumb"><img
                            src="<?php echo esc_url( get_theme_file_uri() ); ?>/asset/images/hqdefault.jpg" alt=""
                            loading="lazy"></div>
