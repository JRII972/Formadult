...
$string['configsupportpage'] = 'Un lien vers cette page sera affichée aux utilisateurs pour contacter l\'assistance du site. Si le champ n\'est pas renseigné, un lien vers le formulaire d\'assistance sera affiché à la place.';
...
$string['testoutgoingmailconf_fromemail_help'] = 'Ce champ permet d\'émuler l\'envoi d\'un message par cet utilisateur, mais l\'entête From utilisée dans le véritable courriel envoyé dépendra d\'autres régalges, comme allowedemaildomains';
...
$string['xmlrpcmnetauthenticationenabled'] = 'L\'authentification MNet est activée sur votre site. Cette fonctionnalité nécessite l\'extension XML-RPC de PHP, qui n\'est plus maintenue par PHP.';
