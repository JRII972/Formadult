...
/**
 * Strings for component 'enrol_programs', language 'fr', version '4.0'.
 *
...
$string['movebefore'] = 'Déplacer « {$a->item} » après « {$a->target} »';
...
$string['notification_endcompleted_subject'] = 'Le programme s\'est terminé';
...
$string['notification_endsoon'] = 'La fin du programme est proche';
...
$string['programend_delay'] = 'Démarrage de la fin après';
...
$string['programs:allocate'] = 'Attribuer les étudiants aux programmes';
...
$string['source_approval_allownew'] = 'Autoriser les apporbations';
...
Vous avez été attribué au programme « {$a->program_fullname} », la date de début est le {$a->program_startdate}.';
