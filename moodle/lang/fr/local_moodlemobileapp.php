...
$string['core.ajaxendpointnotfound'] = '<p>Point de terminaison AJAX introuvable. Ceci peut arriver si le site Moodle est trop ancien ou s\'il bloque l\'accès à ce point de terminaison. L\'app Moodle ne supporte que les versions de Moodle à partir de {{$a}}. Veuillez contacter l\'administrateur de votre site.</p>
<p>{{whoisadmin}}</p>';
...
$string['core.certificaterror'] = '<p>Le certificat de ce site ne peut pas être accepté par votre appareil. Veuillez contacter l\'administrateur de votre site.</p>
<p>{{whoisadmin}}</p>';
