...
$string['activityeditor_help'] = 'Les actions que vous voulez que l\'étudiant effectue pour ce devoir. Ceci n\'est affiché que sur la page de remise, où l\'étudiant modifie et envoie son devoir.';
...
$string['confirmstart'] = 'Votre devoir a une limite de temps de {$a}. Lorsque vous commencez, le chronomètre commence a décompter le temps, qui ne peut pas être arrêté. Vous devez finir le devoir avant qu\'il n\'arrive à échéance. Voulez-vous vraiment commencer maintenant ?';
