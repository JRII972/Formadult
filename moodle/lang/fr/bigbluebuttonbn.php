...
$string['completionview_desc'] = 'L\'étudiant doit rejoindre une réunion ou regarder un enregistrement pour terminer l\'activité.';
$string['completionview_event_desc'] = 'A rejoint la réunion ou regardé un enregistrement {$a} fois';
...
$string['config_dpa_note'] = 'Remarque : afin de remplir vos obligations en terme de protection des données, avant d\'utiliser un fournisseur de service avec ce plugin, vous devez vous assurer d\'avoir lu et accepté l\'accord sur le traitement des données de ce fournisseur.
Pour le service gratuit BigBlueButton par défaut fourni par Blindside Networks Inc., veuillez lire et accepter l\'<a href="{$a}" target="_blank">accord sur le traitement des données</a> suivant.<br />Veuillez consulter vos spécialistes sur la protection des données pour des conseils.';
...
$string['config_lockonjoin_default'] = 'Verrouillage lors de l\'accès activé par défaut';
$string['config_lockonjoin_default_description'] = 'Si ce réglage est activé, les réglages de verrouillage sont appliqués à l\'utilisateur lors de son accès. La configuration de verrouillage doit être activée pour que ce réglage s\'applique.';
$string['config_lockonjoin_editable'] = '« Verrouiller lors de l\'accès » peut être modifié';
$string['config_lockonjoin_editable_description'] = '« Verrouiller lors de l\'accès » peut être modifié quand l\'instance est ajoutée ou modifiée.';
...
$string['config_recordings_sortorder_description'] = 'Par défaut, les enregistrements sont affichés dans l\'ordre décroissant. Si ce réglage est activé, ils seront triés par ordre croissant.';
...
$string['enablingbigbluebuttondpainfo'] = 'Afin de remplir vos obligations en terme de protection des données, avant d\'activer ce plugin, vous devez vous assurer que vous avez lu et accepté l\'<a href="{$a}" target="_blank">accord sur le traitement des données</a> avec Blindside Networks Inc.<br />Veuillez consulter vos spécialistes sur la protection des données pour des conseils.';
...
$string['mod_form_field_lockonjoin'] = 'Réglages de verrouillage lors de l\'accès';
...
$string['view_error_userlimit_reached'] = 'Le nombre d\'utilisateurs autorisés dans une réunion a été atteint.';
